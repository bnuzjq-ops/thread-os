...
> 更新：2026-07-20。新 Agent 或新对话先读本文件，再按需读取下方文档。
>
...
> ✅ 备用账号 `@qq.sifu`（User ID `27572263929068860`）Token 保留本地。
> 当前真实发布已开启（`ENV=production`、`PUBLISH_ENABLED=true`、`DRY_RUN=false`）。
> 12 篇“十神暗面”内容从 2026-07-20 至 2026-07-31 每日 21:00 排期，等待首篇自然到点核验。
